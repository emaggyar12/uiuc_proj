"""
CatBoost playtype model with baseline HS recruit features + scouting report embeddings.
...
- Adds a boolean flag: has_scouting_report_text
- Caches embeddings so rerunning Optuna does not repeatedly re-embed text.
"""
...
feature_cols = base_feature_cols + ["has_scouting_report_text"] + embedding_cols
